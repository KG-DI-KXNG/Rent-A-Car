...
.wrapper {
  position: relative;
  background: url(https://images.unsplash.com/photo-1529004032580-4e2d9a250ba0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80) no-repeat center center/cover;
}
.wrapper:before {
  content: "";
  position: absolute;
...
<link href="assets/css/font-awesome.min.css" rel="stylesheet">
  ...
  const deadlineDate = new Date('February 25, 2022 23:59:59').getTime();
